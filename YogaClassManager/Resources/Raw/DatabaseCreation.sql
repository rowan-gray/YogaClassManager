...
SELECT Pass.PassId                         AS PassId,
       COALESCE(DatedPass.ClassCount, 0) + SUM(COALESCE(PassAlterations.AlerationCount, 0)) +
       COALESCE(TermClasses.ClassCount, 0) AS NumberOfClasses
FROM Pass
         LEFT JOIN PassAlterations
...
CREATE TRIGGER IF NOT EXISTS ClassRoll_ondelete AFTER
DELETE
ON ClassRoll
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassRoll', 'ClassId', OLD.ClassId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS ClassRoll_onupdate AFTER
UPDATE ON ClassRoll
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassRoll', 'ClassId', OLD.ClassId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS ClassRoll_oninsert AFTER INSERT ON ClassRoll
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassRoll', 'ClassId', NEW.ClassId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS ClassSchedule_ondelete AFTER
DELETE
ON ClassSchedule
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassSchedule', 'ClassScheduleId', OLD.ClassScheduleId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS ClassSchedule_onupdate AFTER
UPDATE ON ClassSchedule
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassSchedule', 'ClassScheduleId', OLD.ClassScheduleId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS ClassSchedule_oninsert AFTER INSERT ON ClassSchedule
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassSchedule', 'ClassScheduleId', NEW.ClassScheduleId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS ClassStudents_ondelete AFTER
DELETE
ON ClassStudents
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassStudents', 'ClassId', OLD.ClassId, 'DELETE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassStudents', 'StudentId', OLD.StudentId, 'DELETE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassStudents', 'PassId', OLD.PassId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS ClassStudents_onupdate AFTER
UPDATE ON ClassStudents
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassStudents', 'ClassId', OLD.ClassId, 'UPDATE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassStudents', 'StudentId', OLD.StudentId, 'UPDATE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassStudents', 'PassId', OLD.PassId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS ClassStudents_oninsert AFTER INSERT ON ClassStudents
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassStudents', 'ClassId', NEW.ClassId, 'INSERT');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassStudents', 'StudentId', NEW.StudentId, 'INSERT');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('ClassStudents', 'PassId', NEW.PassId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS DatedPass_ondelete AFTER
DELETE
ON DatedPass
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('DatedPass', 'PassId', OLD.PassId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS DatedPass_onupdate AFTER
UPDATE ON DatedPass
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('DatedPass', 'PassId', OLD.PassId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS DatedPass_oninsert AFTER INSERT ON DatedPass
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('DatedPass', 'PassId', NEW.PassId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS EmergencyContact_ondelete AFTER
DELETE
ON EmergencyContact
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('EmergencyContact', 'EmergencyContactId', OLD.EmergencyContactId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS EmergencyContact_onupdate AFTER
UPDATE ON EmergencyContact
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('EmergencyContact', 'EmergencyContactId', OLD.EmergencyContactId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS EmergencyContact_oninsert AFTER INSERT ON EmergencyContact
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('EmergencyContact', 'EmergencyContactId', NEW.EmergencyContactId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS Pass_ondelete AFTER
DELETE
ON Pass
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Pass', 'PassId', OLD.PassId, 'DELETE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Pass', 'StudentId', OLD.StudentId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS Pass_onupdate AFTER
UPDATE ON Pass
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Pass', 'PassId', OLD.PassId, 'UPDATE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Pass', 'StudentId', OLD.StudentId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS Pass_oninsert AFTER INSERT ON Pass
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Pass', 'PassId', NEW.PassId, 'INSERT');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Pass', 'StudentId', NEW.StudentId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS PassAlterations_ondelete AFTER
DELETE
ON PassAlterations
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('PassAlterations', 'PassAlterationId', OLD.PassAlterationId, 'DELETE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('PassAlterations', 'PassId', OLD.PassId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS PassAlterations_onupdate AFTER
UPDATE ON PassAlterations
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('PassAlterations', 'PassAlterationId', OLD.PassAlterationId, 'UPDATE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('PassAlterations', 'PassId', OLD.PassId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS PassAlterations_oninsert AFTER INSERT ON PassAlterations
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('PassAlterations', 'PassAlterationId', NEW.PassAlterationId, 'INSERT');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('PassAlterations', 'PassId', NEW.PassId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS Person_ondelete AFTER
DELETE
ON Person
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Person', 'PersonId', OLD.PersonId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS Person_onupdate AFTER
UPDATE ON Person
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Person', 'PersonId', OLD.PersonId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS Person_oninsert AFTER INSERT ON Person
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Person', 'PersonId', NEW.PersonId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS Student_ondelete AFTER
DELETE
ON Student
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Student', 'StudentId', OLD.StudentId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS Student_onupdate AFTER
UPDATE ON Student
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Student', 'StudentId', OLD.StudentId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS Student_oninsert AFTER INSERT ON Student
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Student', 'StudentId', NEW.StudentId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS StudentEmergencyContacts_ondelete AFTER
DELETE
ON StudentEmergencyContacts
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('StudentEmergencyContacts', 'StudentId', OLD.StudentId, 'DELETE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('StudentEmergencyContacts', 'EmergencyContactId', OLD.EmergencyContactId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS StudentEmergencyContacts_onupdate AFTER
UPDATE ON StudentEmergencyContacts
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('StudentEmergencyContacts', 'StudentId', OLD.StudentId, 'UPDATE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('StudentEmergencyContacts', 'EmergencyContactId', OLD.EmergencyContactId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS StudentEmergencyContacts_oninsert AFTER INSERT ON StudentEmergencyContacts
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('StudentEmergencyContacts', 'StudentId', NEW.StudentId, 'INSERT');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('StudentEmergencyContacts', 'EmergencyContactId', NEW.EmergencyContactId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS StudentHealthConcerns_ondelete AFTER
DELETE
ON StudentHealthConcerns
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('StudentHealthConcerns', 'StudentId', OLD.StudentId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS StudentHealthConcerns_onupdate AFTER
UPDATE ON StudentHealthConcerns
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('StudentHealthConcerns', 'StudentId', OLD.StudentId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS StudentHealthConcerns_oninsert AFTER INSERT ON StudentHealthConcerns
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('StudentHealthConcerns', 'StudentId', NEW.StudentId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS Term_ondelete AFTER
DELETE
ON Term
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Term', 'TermId', OLD.TermId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS Term_onupdate AFTER
UPDATE ON Term
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Term', 'TermId', OLD.TermId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS Term_oninsert AFTER INSERT ON Term
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('Term', 'TermId', NEW.TermId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS TermClasses_ondelete AFTER
DELETE
ON TermClasses
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('TermClasses', 'TermId', OLD.TermId, 'DELETE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('TermClasses', 'ClassId', OLD.ClassId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS TermClasses_onupdate AFTER
UPDATE ON TermClasses
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('TermClasses', 'TermId', OLD.TermId, 'UPDATE');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('TermClasses', 'ClassId', OLD.ClassId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS TermClasses_oninsert AFTER INSERT ON TermClasses
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('TermClasses', 'TermId', NEW.TermId, 'INSERT');
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('TermClasses', 'ClassId', NEW.ClassId, 'INSERT');
END;
...
CREATE TRIGGER IF NOT EXISTS TermPass_ondelete AFTER
DELETE
ON TermPass
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('TermPass', 'PassId', OLD.PassId, 'DELETE');
END;

CREATE TRIGGER IF NOT EXISTS TermPass_onupdate AFTER
UPDATE ON TermPass
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('TermPass', 'PassId', OLD.PassId, 'UPDATE');
END;

CREATE TRIGGER IF NOT EXISTS TermPass_oninsert AFTER INSERT ON TermPass
BEGIN
INSERT INTO modifications (table_name, id_name, id_value, action)
VALUES ('TermPass', 'PassId', NEW.PassId, 'INSERT');
END;
COMMIT;