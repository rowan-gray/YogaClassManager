...
internal class NavigationService
{
        ...
        bool? saveToDatabase = null)
    {
        ...
        if (voidReturn is not null) parameters.Add("voidReturn", new Message(voidReturn));
        if (passReturn is not null) parameters.Add("passReturn", new Message(passReturn));
        if (classRestriction is not null) parameters.Add("class", new Message(classRestriction));
        if (passType is not null) parameters.Add("defaultPassType", new Message(passType));
        if (saveToDatabase is not null) parameters.Add("saveToDatabase", new Message(saveToDatabase));

        await NavigateToAsync(nameof(AddPassPageModel), parameters);
    }

    public static async Task NavigateToEditPassPage(Pass pass, Action? voidCallback = null,
        Action<Pass>? passCallback = null, bool? saveToDatabase = null)
    {
        var parameters = new Dictionary<string, object>();
        ...
        if (voidCallback is not null) parameters.Add("voidCallback", new Message(voidCallback));
        if (passCallback is not null) parameters.Add("passCallback", new Message(passCallback));
        if (saveToDatabase is not null) parameters.Add("saveToDatabase", new Message(saveToDatabase));

        await NavigateToAsync(nameof(EditPassPageModel), parameters);
    }

    public static async Task NavigateToAddStudentPage(Action<int>? idReturn = null,
        Action<Student>? studentReturn = null)
    {
        var parameters = new Dictionary<string, object>();

        if (idReturn is not null) parameters.Add("idReturn", new Message(idReturn));
        if (studentReturn is not null) parameters.Add("studentReturn", new Message(studentReturn));

        await NavigateToAsync(nameof(AddStudentPageModel), parameters);
    }

    public static async Task NavigateToAddEmergencyContactPage(Student student, Action? voidCallback = null,
        Action<EmergencyContact>? emergencyContactCallback = null, bool? saveToDatabase = null)
    {
        var parameters = new Dictionary<string, object>();
    ...
    public static async Task NavigateToEditEmergencyContactPage(EmergencyContact emergencyContact,
        Action? voidCallback = null, Action<EmergencyContact>? emergencyContactCallback = null,
        bool? saveToDatabase = null)
    {
        var parameters = new Dictionary<string, object>();
    ...
    public static async Task NavigateToAddPersonPage(Action<int>? idReturn = null, Action<Person>? personReturn = null,
        bool saveToDatabase = true)
    {
        var parameters = new Dictionary<string, object>();

        if (idReturn is not null) parameters.Add("idCallback", new Message(idReturn));
        if (personReturn is not null) parameters.Add("personCallback", new Message(personReturn));
    ...
    internal static async Task NavigateToEditClassSchedulePage(ClassSchedule classSchedule)
    {
        var parameters = new Dictionary<string, object>();
    ...
    internal static async Task NavigateToEditTermPage(Term term)
    {
        var parameters = new Dictionary<string, object>();
    ...
    internal static async Task NavigateToStudentPassesPage(Student student)
    {
        var parameters = new Dictionary<string, object>();
