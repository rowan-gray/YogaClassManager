...
public partial class EditEmergencyContactPageModel : ObservableObject
{
    ...
    [ObservableProperty] private EmergencyContact emergencyContact;
    ...
    public Message EmergencyContactParameter
    {
        set => EmergencyContact = (EmergencyContact)value.Parameter;
    }
    ...
    public async void SaveCommandExecute()
    {
        ...
        if (SaveToDatabase) success = await SaveEmergencyContactToDatabase(EmergencyContact);
