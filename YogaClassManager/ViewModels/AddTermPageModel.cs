...
public partial class AddTermPageModel : ObservableObject
{
    ...
    public AddTermPageModel(DatabaseManager databaseManager, PopupService popupService)
    {
        ...
        Term = new Term(-1, null, DateOnly.FromDateTime(DateTime.Now),
            DateOnly.FromDateTime(DateTime.Now.AddDays(7 * 10)), null, null, new List<TermClassSchedule>());
    ...
    {
        set => Callback = (Action<int>)value.Parameter;
    }
