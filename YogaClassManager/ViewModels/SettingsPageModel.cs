...
public partial class SettingsPageModel : ObservableObject
{
    ...
    [ObservableProperty] private string dbFilePath;
    ...
    private async void CreateFile()
    {
        try
        {
            ...
            {
                var folderPath = await popupService.DisplayPromptAsync("Specify folder",
                    "Please enter the folder where you'd like the database to be created", "Continue");
                ...
                {
                    await popupService.DisplayAlert("Invalid Location", "A database already exists in that location",
                        "Ok");
                    return;
                }
