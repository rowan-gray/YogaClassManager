...
public partial class AddStudentPageModel : ObservableObject
{
    ...
    public AddStudentPageModel(DatabaseManager databaseManager, PopupService popupService)
    {
        ...
        Student = new Student(-1, "", "", null, null, new ObservableCollection<Pass>(),
            new ObservableCollection<EmergencyContact>(), new ObservableCollection<string>(), true);

        CancelCommand = new Command(CancelCommandExecute);
        AddCommand = new Command(AddCommandExecute, AddCommandCanExecute);
        UpdateSaveCommandCanExecute = new Command(() => AddCommand?.ChangeCanExecute());
        ...
        EditHealthConcernCommand = new Command(EditHealthConcernCommandExecute, ModifyHealthConcernCommandsCanExecute);
        RemoveHealthConcernCommand =
            new Command(RemoveHealthConcernCommandExecute, ModifyHealthConcernCommandsCanExecute);
    }
    ...
    public Message StudentReturnParameter
    {
        set => StudentReturn = (Action<Student>)value.Parameter;
    }
    ...
    {
        await NavigationService.NavigateToAddEmergencyContactPage(Student,
            emergencyContactCallback: EmergencyContactAdded, saveToDatabase: false);
    }
    ...
    private async void EditEmergencyContactCommandExecute()
    {
        ...
        await NavigationService.NavigateToEditEmergencyContactPage(SelectedEmergencyContact,
            emergencyContactCallback: EmergencyContactEdited, saveToDatabase: false);
    }
    ...
    {
        await NavigationService.NavigateToAddPassPage(Student.Copy(Student), passReturn: PassAdded,
    ...
    private async void EditPassCommandExecute()
    {
        ...
        await NavigationService.NavigateToEditPassPage(pass, passCallback: PassEdited, saveToDatabase: false);
    }
    ...
    private async void EditHealthConcernCommandExecute()
    {
        ...
        var updatedHealthConcern = await popupService.DisplayPromptAsync("Health Concern",
            "What would you like this health concern to be?", initialValue: SelectedHealthConcern);
        ...
        updatedHealthConcern =
            updatedHealthConcern.Substring(0, 1).ToUpperInvariant() + updatedHealthConcern.Substring(1);
