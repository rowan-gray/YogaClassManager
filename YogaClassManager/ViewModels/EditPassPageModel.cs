...
public partial class EditPassPageModel : ObservableObject
{
    ...
    [ObservableProperty] private Pass editingPass;
    ...
    public Message PassParameter
    {
        set
        {
            ...
            NewAlteration = new PassAlteration(-1, EditingPass.Id, 0, null);
    ...
    private void AddAlterationCommandExecute(object obj)
    {
        ...
        NewAlteration = new PassAlteration(-1, EditingPass.Id, 1, null);
        SaveCommand?.ChangeCanExecute();
    }
