...
public partial class TermPass : Pass
{
    ...
    public TermPass(int id, int studentId, int classesUsed, ObservableCollection<PassAlteration> alterations, Term term,
    ...
    public override int NumberOfClasses
    {
        get
        {
            if (TermClassSchedule == null) return 0;
    ...
    public override bool IsExpired
    {
        get
        {
            ...
            if ((date > Term.EndDate && Term.CatchupEndDate is null) || date > Term.CatchupEndDate) return true;
    ...
    {
        return base.IsValid() && Term != null && TermClassSchedule != null && NumberOfClasses > 0 &&
               ClassesRemaining >= 0;
    }
